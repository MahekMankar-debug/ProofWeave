...
/**
 * @title ProofWeave Token (PWEAVE)
 * @dev Standard ERC20 Token with minting, burning, and ownership control
 */
contract ProofWeave {
    string public name = "ProofWeave";
    string public symbol = "PWEAVE";
    ...
    // Constructor sets deployer as owner and mints initial supply
